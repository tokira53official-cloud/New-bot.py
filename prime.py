...
def load_billing_data():
    try:
        ...
        return {"coupons": {}, "plan_claims": {}}

billing_data = load_billing_data()

VPS_PLANS = {
    "2gb":  {"ram": 2,  "cpu": 1, "disk": 20, "price": 50},
    "4gb":  {"ram": 4,  "cpu": 1, "disk": 30, "price": 100},
    "6gb":  {"ram": 6,  "cpu": 1, "disk": 30, "price": 120},
    "8gb":  {"ram": 8,  "cpu": 1, "disk": 40, "price": 150},
    # The user specified 10GB resources but did not provide a monthly price.
    # Keep it out of the purchasable list until a price is defined.
    "12gb": {"ram": 12, "cpu": 2, "disk": 60, "price": 200},
    "16gb": {"ram": 16, "cpu": 2, "disk": 70, "price": 250},
}
